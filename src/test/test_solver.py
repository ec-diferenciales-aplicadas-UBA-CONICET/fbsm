...
class StrictIncrDecrTest(unittest.TestCase):
    def test_increasing_values(self):
        v = [-12, 0, 3, 4, 7, 9, 15]
        self.assertTrue(strict_incr(v))
        self.assertFalse(strict_decr(v))

    def test_decreasing_values(self):
        v = [37, 32, 10, 8, -2, -4]
        self.assertFalse(strict_incr(v))
        self.assertTrue(strict_decr(v))
